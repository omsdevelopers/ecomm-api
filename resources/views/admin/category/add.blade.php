              ...
              <form   action="" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" name="meta_title" class="form-control" id="exampleInputEmail1" placeholder="Meta Title" required> {{old('meta_title')}}</textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="meta_keywords" class="form-control" id="exampleInputEmail1" placeholder="Meta Keywords" value="{{old('meta_keywords')}}" required>
                  </div>
