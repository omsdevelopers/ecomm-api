            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="file" name="image" class="form-control" id="exampleInputEmail1" placeholder="Slug" value="">
                  @if ($getRecord->image)
                  <img src="{{ url('public/storage/images/' . $getRecord->image) }}" width="150" height="100" alt="Product Image">
                  @endif
                </div>
