    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <h4 class="mt-4">Interpretation and Definitions</h4>
                ...
                <ul>
                    ...
                    <li><strong>Affiliate</strong> means an entity that controls, is controlled by, or is under common
                        ...
                        or other securities entitled to vote for the election of directors or other managing authority.</li>
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                        Agreement) refers to Hi-Fi.</li>
                    ...
                    <li><strong>Usage Data</strong> refers to data collected automatically, either generated by the use of
                        the Service or from the Service infrastructure itself.</li>
                ...
                <!-- Collecting and Using Your Personal Data content -->
                ...
                <h4 class="mt-4">Tracking Technologies and Cookies</h4>
                ...
                <!-- Tracking Technologies and Cookies content -->
                ...
                <ol>
                    <li><strong>To provide and maintain our Service, including to monitor the usage of our Service.</strong>
                    </li>
                    ...
                    <li><strong>To provide You with news, special offers and general information about other goods,
                            services, and events which we offer that are similar to those that you have already purchased or
                            inquired about unless You have opted not to receive such information.</strong></li>
                    ...
                    <li><strong>For business transfers:</strong> We may use Your information to evaluate or conduct a
                        ...
                        or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or a similar
                ...
                <ul>
                    ...
                    <!-- Use of Your Personal Data content -->

                    <!-- Retention of Your Personal Data -->
                    <h4 class="mt-4">Retention of Your Personal Data</h4>
                    ...
                    <!-- Retention of Your Personal Data content -->

                    <!-- Transfer of Your Personal Data -->
                    <h4 class="mt-4">Transfer of Your Personal Data</h4>
                    ...
                    <!-- Transfer of Your Personal Data content -->

                    <!-- Delete Your Personal Data -->
                    <h4 class="mt-4">Delete Your Personal Data</h4>
                    ...
                    <h4 class="mt-4">Other Legal Requirements</h4>
                    ...
                    <h4 class="mt-4">Links to Other Websites</h4>
