                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-12">
                                    <div class="bd-hero__content z-index-11 p-relative">
                                        <span class="animated fadeInUp">Welcome to our dairy farm</span>
                                        <h2 class="animated fadeInUp">dairypress</h2>
                    ...
                    <div class="hero__height d-flex align-items-center p-relative">
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-xl-12">
                                    <div class="bd-hero__content z-index-11 p-relative">
                                        <span data-animation="fadeInUp" data-delay=".3s">Welcome to our dairy
                                            farm</span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="bd-features__item text-center mb-60">
                            ...
                            <div class="bd-features__content">
                                ...
                                <a class="bd-link__btn" href="about.html">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
...
<section class="bd-service__area pt-30 pb-55">
    <div class="container">
        ...
        <div class="row">
            ...
            @if ($key < 10) <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <a href="{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}">
                            ...
                            <div class="bd-service__content">
                                <h5 class="text-center"><a
                                        href="{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}">{{Str::limit($category->name,
                                        12)}}</a></h5>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="bd-product__item text-center mb-30">
                    ...
                    <div class="bd-product__action">
                        ...
                        <a href="#" data-toggle="tooltip" data-placement="top" title="Quick Shop" data-bs-toggle="modal"
